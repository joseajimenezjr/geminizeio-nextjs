        ...
        {step === "wiring-instructions" && (
          <div className="p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4">
                <h4 className="font-medium mb-2">Step 2: Mount the Turn Signal Kit</h4>
                <p className="text-sm text-muted-foreground">
                  Secure the turn signal kit to a clean, dry surface using the provided mounting hardware.
                </p>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Connect each turn signal to the corresponding terminal. Refer to the manual for detailed wiring
                  diagrams.
                </p>
              </div>
